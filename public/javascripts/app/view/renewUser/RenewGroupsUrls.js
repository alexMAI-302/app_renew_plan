Ext.define('app.view.renewUser.RenewGroupsUrls', {
	...
	models: ['app.model.renewUser.RenewUrl'],

	itemId: 'detailUrlPanelId',
	height: 400,
	...
	constructor: function(config) {
		var store = Ext.create('Ext.data.Store', {
			storeId: 'dropDownUrlStore',
			model: 'app.model.renewUser.RenewUrl',
			autoLoad: true
		});
